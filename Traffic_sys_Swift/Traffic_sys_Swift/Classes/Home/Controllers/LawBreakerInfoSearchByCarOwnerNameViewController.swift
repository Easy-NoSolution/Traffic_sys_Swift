//
//  LawBreakerInfoSearchByCarOwnerNameViewController.swift
//  Traffic_sys_Swift
//
...
class LawBreakerInfoSearchByCarOwnerNameViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
//        1.创建cell
        let cell = LawBreakerInfoSearchByCarOwnerNameViewCell.searchCellWithTableView(tableView: tableView) as! LawBreakerInfoSearchByCarOwnerNameViewCell
...
// MARK: - 设置UI界面
extension LawBreakerInfoSearchByCarOwnerNameViewController {
    
    func setupNavigationItem() {
//        1.设置标题
        titleTextField.placeholder = "请输入车主姓名"
...
//        1.获取参数
        let carOwnerName: String = titleTextField.text ?? ""
...
//        3.发送网络请求
        ...
        NetworkTools.shareInstance.searchLawbreakerInfoByCarOwnerName(carOwnerName: carOwnerName) {[weak self] (response, error) in
...
extension LawBreakerInfoSearchByCarOwnerNameViewController: UITextFieldDelegate {
