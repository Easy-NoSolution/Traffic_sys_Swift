...
class CarOwnerInfoCheckInViewController: UITableViewController {

    // MARK: - 自定义属性
    lazy var titles: Array<String> = ["身份证号码", "姓名", "性别", "出生日期", "家庭住址", "电话号码"]
    lazy var userAvatarBtn: UIButton = UIButton()
    ...
    override func viewDidLoad() {
        ...
        userAvatarBtn.setBackgroundImage(UIImage(named: "addImage"), for: .normal)
    }
...
//        3.返回cell
    ...
    override func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        footer.addSubview(userAvatarBtn)
